...
print("🔍 ۱. اسکن و استخراج کدهای مربوط به depositAndBorrow...")
...
print("\n🔍 ۲. استعلام آدرس توکن‌ها از قرارداد Vault...")
...
print("\n🧪 ۴. تست اجرای depositAndBorrow با شناسه‌های مختلف...")
for att in [17, 18, 1, 0]:
    print(f"\n--- تست با Attestation ID = {att} ---")
    ...
    if "status               1" in res or "status               0x1" in res:
        print(f"🎉 تراکنش با موفقیت انجام شد! Attestation ID: {att}")
        break
    else:
        print(res)
